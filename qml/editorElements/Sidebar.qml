...
MultiResolutionImage {
  ...
  property var buttons: [groundButton, ground2Button, platformButton, emptyBlockButton, breakBlockButton, opponentJumperButton, opponentWalkerButton, spikeballButton, spikesButton, finishButton, coinButton, mushroomButton, starButton, brickBlockButton, questionBlockButton]
  ...
  Item {
    ...
    Row {
      ...
      PlatformerImageButton {
        ...
        hoverRectangle.visible: undoHandler.pointer >= 0
      ...
      PlatformerImageButton {
        ...
        hoverRectangle.visible: undoHandler.pointer < undoHandler.undoArray.length - 1
    ...
    Flickable {
      ...
      Column {
            ...
            Connections {
              ...
              onTextInputFinished: {
                ...
                if(accepted) {
                  ...
                  // the text can't be longer than 15 characters
        ...
        PlatformerBuildEntityButton {
          ...
          toCreateEntityTypeUrl: "../entities/Blocks.qml"
        ...
        PlatformerBuildEntityButton {
          ...
          toCreateEntityTypeUrl: "../entities/BlocksBreak.qml"
        ...
        PlatformerBuildEntityButton {
          ...
          toCreateEntityTypeUrl: "../entities/BlocksBrick.qml"
        ...
        PlatformerBuildEntityButton {
          id: questionBlockButton

          visible: entityGroups.activeGroup == 3

          toCreateEntityTypeUrl: "../entities/BlocksQuest.qml"
  ...
  function updateActiveTool() {
    if(drawEraseButton.isSelected)
      activeTool = drawEraseButton.drawActive ? "draw" : "erase"
    else
      activeTool = handButton.isSelected ? "hand" : ""
  }
