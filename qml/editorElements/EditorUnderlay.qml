...
PinchArea {
  ...
  // Note: The MouseArea is inside the PinchArea for both areas to work.
  ...
  MouseArea {
    ...
    // in every frame.
    property real lastCreateTime: 0
    ...
    onWheel: {
      ...
      scene.camera.applyZoom(wheel.angleDelta.y > 0 ? 1.05 : 1 / 1.05, mousePos)
